...
class ElasticsearchDAO(object):
    def __init__(self, elasticsearch_api_base_url: str = None):
        self.elasticsearch_api_base_url = elasticsearch_api_base_url

    def write_to_elasticsearch(self, metrics: [DHMetric]):
    ...
    def map_obj_doc(self, metric: DHMetric, line_obj_doc):
        new_lineobj_doc = {}
